            ...
            <div>
                <div>
                    ...
                    <form action="action_nhanvien.php" method="post" enctype="multipart/form-data" class="mt-4">
                        ...
                        <div class="mb-4">
                            <select name="id_bp" class="border rounded-lg px-4 py-2 w-full text-xs font-medium text-gray-500 uppercase tracking-wider" required>
                        ...
                        <div class="mb-4">
                            <select name="id_pb" class="border rounded-lg px-4 py-2 w-full text-xs font-medium text-gray-500 uppercase tracking-wider" required>
