...
<footer class="bg-yellow-900 rounded-lg">
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <ul class="mt-12 flex justify-center gap-6 md:gap-8">
        <li>
          <a href="https://www.facebook.com/TiemVangKimChungNhaTrang/?locale=vi_VN" rel="noreferrer" target="_blank" class="text-white transition hover:text-pink-300">
        ...
        <li>
          <a href="https://twitter.com/home" rel="noreferrer" target="_blank" class="text-white transition hover:text-pink-300">
        ...
        <li>
          <a href="https://github.com/legiahung/ChuyenDe" rel="noreferrer" target="_blank" class="text-white transition hover:text-pink-300">
